...
with a periodic thickness pattern that mirrors the wire
layout~\cite{enomae2010laidlines}. Held up to a strong light, this
...
Closest in spirit to the present project is the moldmate-
...
rather than as a single flat-lit value; the DRM differs from a
...
giving a per-folio manual ground truth that is set against both
