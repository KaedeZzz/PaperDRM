...
holdings~\cite{miniare}. These stacks contain far more
...
column sum. Subsequent variants substituted Gabor filter banks,
autocorrelation, or wavelet decompositions. These methods are simple to implement and reasonably
...
crystalline metallic samples~\cite{wittwer2021drm}, and its first
